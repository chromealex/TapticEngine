...
namespace ME.Taptic {
    ...
    public class TapticAnimationCurveImpl : ITapticModuleInternal {
        ...
        private System.Collections.Generic.List<TapticChain> searchCache = new System.Collections.Generic.List<TapticChain>();
        private System.Collections.Generic.List<TapticChain> searchCacheRnd = new System.Collections.Generic.List<TapticChain>();
        ...
        void ITapticModule.PlayCurve(AnimationCurve curve, bool randomize) {
            ...
            this.ValidateChannels();
            for (int i = 0; i < this.channels.Length; ++i) this.channels[i] = 0f;
        ...
        private TapticChain FindItemNearestToDurationAndStrength(float maxDuration, float maxStrength, bool randomize) {
            ...
            for (int i = 0; i < this.tapticChains.Length; ++i) {
            ...
            max = float.MaxValue;
            for (int i = 0; i < this.searchCache.Count; ++i) {
        ...
        private void ValidateChannels() {
            ...
            if (this.channels == null || this.channels.Length != this.maxChannels) this.channels = new float[this.maxChannels];
